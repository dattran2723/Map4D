    ...
    $('#list-contact').DataTable({
        ...
        columns: [
            ...
            },
            {
                data: "Id",
                render: function (data) {
                    /*'<a data-toggle="tooltip" title="Sửa" href="/admin/Home/editcontact?id=' + data+ '" > <i class="fas fa-edit"></i></a > ' + ' ' +*/
                    return '<a data-toggle="tooltip" title="Chi tiết" href="/admin/Home/ContactDetail?id=' + data + '"><i class="fas fa-info-circle"></i></a>' + ' ' +
